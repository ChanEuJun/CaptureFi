      ...
      `}
        >
            <div className="flex gap-4">
                {/* Type Icon */}
                <div className={`w-12 h-12 rounded-full shrink-0 flex items-center justify-center ${isLong ? "bg-green-500/10 text-green-500" : "bg-red-500/10 text-red-500"}`}>
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                        ...
                        <Badge
                            variant="outline"
                            className={`text-[10px] uppercase font-bold py-0 ${isLong ? "border-green-500/50 text-green-500 bg-green-500/10" : "border-red-500/50 text-red-500 bg-red-500/10"}`}
                        >
                            {item.side}
                        </Badge>
                    </div>
